<x-layout>
    ...
    <svg id="xmas_lights" viewBox="0 0 800 800">
        ...
        <path class="red_bulb bulb blink-1"
        ...
        <path class="green_bulb blink-2 bulb"
        ...
        <path class="blue_bulb blink-3 bulb"
        ...
        <path class="red_bulb blink-4 bulb"
        ...
        <path class="green_bulb blink-5 bulb"
        ...
        <path class="white_bulb blink-6 bulb"
        ...
        <path class="blue_bulb blink-7 bulb"
        ...
        <path class="red_bulb blink-1 bulb"
        ...
        <path class="gold_bulb bulb blink-9"
        ...
        <path class="green_bulb blink-10 bulb"
        ...
        <path class="blue_bulb blink-1 bulb"
        ...
        <path class="red_bulb blink-2 bulb"
        ...
        <path class="white_bulb blink-3 bulb"
        ...
        <path class="green_bulb blink-4 bulb"
        ...
        <path class="blue_bulb blink-5 bulb"
        ...
        <path class="red_bulb blink-6 bulb"
        ...
        <path class="gold_bulb blink-7 bulb"
        ...
        <path class="green_bulb bulb blink-9"
        ...
        <path class="blue_bulb blink-10 bulb"
        ...
        <path class="white_bulb blink-2 bulb"
        ...
        <path class="green_bulb blink-3 bulb"
        ...
        <path class="red_bulb blink-5 bulb"
    ...
    <div class="container">
        ...
        <div class="col-lg-4" id="third_col"></div>
    </div>

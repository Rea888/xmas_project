if ("ontouchstart" in window){ /*ako uredjaj poseduje touchscreen pokreni funkciju*/
    /*alert("handy")
  document.write("your device is a touch screen device.");

  document.addEventListener("touchstart", ()=>{
          alert("tach skrin jje  bez brige");
  ...
  */
    ...
    function glavna_funkcija(){
        ...
        //odredjivanje onih divova koje treba da budu draggable
        ...
        let povrsina = document.getElementById("primary"); // prostor koji je draggable
        ...
        function pomeranje_po_ekranu(ev){// kada datu sliku pokrecemo po ekranu
            //ev.preventDefault();
            ...
            if(pomeri.top < 10 ){ //skrolanje slikom ako predje ivice ekrana gore i dole
